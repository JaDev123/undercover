...
public class Target : MonoBehaviour {
    ...
    void Start()
    {
        ...
        GameObject audio = GameObject.FindWithTag("BirdCall");
...
*/
        ...
        if (other.gameObject.CompareTag("Player")|| other.gameObject.CompareTag("AllyBird"))
        {
            //Instantiate(sound);
            sound.Play();
           // Destroy(sound);
            ...
            Vector3 expPos = gameObject.GetComponent<Transform>().position + new Vector3(0, 0, 50);

            Instantiate(exp, expPos, Quaternion.identity);
            //Instantiate(heart, expPos, Quaternion.identity);
             Instantiate(allys[rand], expPos, Quaternion.identity);
           // Instantiate(allys[0], expPos, Quaternion.identity);
